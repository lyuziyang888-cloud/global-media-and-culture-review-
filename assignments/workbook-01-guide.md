...
1. briefly explain the report topic
...
4. use at least two key ideas from each paradigm
...
- critical analysis of the report and evidence of understanding its data
- a persuasive argument supporting the selected paradigm

## Recommended 500-Word Structure

| Section | Approximate words | Job |
|---|---:|---|
| Introduction | 50-60 | identify the trend and state which paradigm explains it better |
| Media imperialism | 140-160 | apply two key ideas to specific report data |
| Cultural globalisation | 140-160 | apply two key ideas to the same trend and data |
...
**Report connection:** Netflix, Amazon Prime Video, Disney+, Apple TV+, Paramount+ and Max decide which regions and genres receive commissions.

**Analysis:** Investment outside North America does not automatically transfer power to local industries. The streamers retain the ability to finance, select and distribute content across markets.

**Useful sentence:**

```text
From a media-imperialism perspective, the decline in North America's
share of commissions does not represent the disappearance of US power,
because predominantly US-based streaming corporations still control
...
**Report connection:** Asia-Pacific investment is concentrated in selected growth markets such as Japan, India and Thailand, while several other regions retain only modest shares.

**Analysis:** The pattern suggests selective corporate expansion rather than an equal redistribution of global media capacity. Local industries may benefit, but their access to global audiences depends on platform strategies and subscriber potential.

**Useful sentence:**

```text
The uneven distribution of commissions suggests a continuing
core-periphery structure in which selected markets gain investment,
while others remain marginal and local producers depend on global
